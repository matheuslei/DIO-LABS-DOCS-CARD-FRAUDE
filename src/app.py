...
def show_image_and_validation(blob_url, credit_card_info):
    ...
    if credit_card_info and credit_card_info["card_name"]:
        ...
        st.markdown(f"Nome do Titular: {credit_card_info['card_name']}")
        st.markdown(f"Banco Emissor: {credit_card_info['bank_name']}")
        st.markdown(f"Data de validade: {credit_card_info['expiry_date']}")
    else:
